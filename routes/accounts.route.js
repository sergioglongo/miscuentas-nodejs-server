...
import { adjustAccount, createEditAccount, getAccountById, getAllAccounts, getAllAccountsByUnitId, getAllAccountsForTransfer } from '../controllers/account.controller.js';
...
accountRouter.post("/getAllForTransfer", getAllAccountsForTransfer);
