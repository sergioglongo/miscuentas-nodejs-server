...
import { createEditArea, getAllAreas, getAllAreasBody, getAllAreasByUnitId, getAreaById } from '../controllers/area.controller.js';

const areaRouter = express.Router();

areaRouter.get("/getAll", getAllAreas);
areaRouter.post("/getAllBody", getAllAreasBody);
